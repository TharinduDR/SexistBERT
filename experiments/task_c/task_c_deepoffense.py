...
from experiments.task_c.deepoffense_config import TEMP_DIRECTORY, args, SEED, RESULT_FILE
...
train = train.rename(columns={'label_vector': 'labels'})
...
model = ClassificationModel(MODEL_TYPE, MODEL_NAME, args=args, num_labels=11,
